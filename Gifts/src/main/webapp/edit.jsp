...
<div class="layui-form layuimini-form">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="nick" lay-verify="required" lay-reqtext="用户昵称不能为空" value="" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="openId" lay-verify="required" lay-reqtext="openId不能为空"
                   value="" disabled
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="sessionKey" lay-verify="required" lay-reqtext="sessionKey不能为空" value=""
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea name="imgUrl" class="layui-textarea"></textarea>
        </div>
    </div>
    ...
    layui.use(['form'], function () {
        ...
        form.on('submit(saveBtn)', function (data) {
            var index = layer.alert(JSON.stringify(data.field), {
                ...
                layer.close(index);
                $.ajax({
                    url:'${pageContext.request.contextPath}/admins/edit',
                    type: "POST",
                    dataType: "json",
