    ...
    <div class="layui-side layui-bg-black">
        <ul class="layui-nav layui-nav-tree layui-left-nav-tree" id="multi_module_0">
            ...
            <li class="layui-nav-item menu-li  "><a href="javascript:;"
                                                    layuimini-href="${pageContext.request.contextPath}/admins/welcome"
                                                    target="_self"> <i class="fa fa-gears"></i> <span
                    class="layui-left-nav">主页</span></a></li>
            <li class="layui-nav-item menu-li  "><a href="javascript:;" layuimini-href="/admins/setting"
                                                    target="_self"> <i class="fa fa-gears"></i> <span
