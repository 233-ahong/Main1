...
<div class="layui-layout layui-layout-admin">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a data-icon="fa fa-gears" data-title="修改密码" href="javascript:;"
                               layuimini-content-href="/admins/setPassword">修改密码</a>
                        </dd>
                        <dd>
                            <hr>
                        </dd>
    ...
    <div class="layui-side layui-bg-black">
        <ul class="layui-nav layui-nav-tree layui-left-nav-tree" id="multi_module_0">
            ...
            <li class="layui-nav-item menu-li  "><a href="javascript:;"
                                                    layuimini-href="${pageContext.request.contextPath}/admins/table"
                                                    target="_self">
                <i class="fa fa-file-text"></i> <span class="layui-left-nav">用户管理</span></a></li>
            <li class="layui-nav-item menu-li  "></li>
            <span class="layui-nav-bar"></span></ul>
        <%--<ul class="layui-nav layui-nav-tree layui-left-nav-tree layui-hide" id="multi_module_1">
            <li class="layui-nav-item menu-li  "><a href="javascript:;" layuimini-href="page/icon.html" target="_self">
                <i class="fa fa-dot-circle-o"></i> <span class="layui-left-nav">图标列表</span></a></li>
            <li class="layui-nav-item menu-li  "><a href="javascript:;" layuimini-href="page/icon-picker.html"
                                                    target="_self"> <i class="fa fa-adn"></i> <span
                    class="layui-left-nav">图标选择</span></a></li>
            <li class="layui-nav-item menu-li  "><a href="javascript:;" layuimini-href="page/color-select.html"
                                                    target="_self"> <i class="fa fa-dashboard"></i> <span
                    class="layui-left-nav">颜色选择</span></a></li>
            <li class="layui-nav-item menu-li  "><a href="javascript:;" layuimini-href="page/table-select.html"
                                                    target="_self"> <i class="fa fa-angle-double-down"></i> <span
                    class="layui-left-nav">下拉选择</span></a></li>
            <li class="layui-nav-item menu-li  "><a href="javascript:;" layuimini-href="page/upload.html"
                                                    target="_self"> <i class="fa fa-arrow-up"></i> <span
                    class="layui-left-nav">文件上传</span></a></li>
            <li class="layui-nav-item menu-li  "><a href="javascript:;" layuimini-href="page/editor.html"
                                                    target="_self"> <i class="fa fa-edit"></i> <span
                    class="layui-left-nav">富文本编辑器</span></a></li>
            <li class="layui-nav-item menu-li  "><a href="javascript:;" layuimini-href="page/area.html" target="_self">
                <i class="fa fa-rocket"></i> <span class="layui-left-nav">省市县区选择器</span></a></li>
            <span class="layui-nav-bar"></span></ul>--%>
        <%--<ul class="layui-nav layui-nav-tree layui-left-nav-tree layui-hide" id="multi_module_2">
            <li class="layui-nav-item menu-li  "><a href="javascript:;"> <i class="fa fa-meetup"></i> <span
                    class="layui-left-nav">多级菜单</span><span class="layui-nav-more"></span></a>
                <dl class="layui-nav-child ">
                    <dd class="menu-dd  "><a href="javascript:;" target="_self"> <i class="fa fa-calendar"></i> <span
                            class="layui-left-nav"> 按钮1</span><span class="layui-nav-more"></span></a>
                        <dl class="layui-nav-child ">
                            <dd class="menu-dd  "><a href="javascript:;" target="_self"> <i
                                    class="fa fa-snowflake-o"></i> <span class="layui-left-nav"> 按钮2</span><span
                                    class="layui-nav-more"></span></a>
                                <dl class="layui-nav-child ">
                                    <dd class="menu-dd  "><a href="javascript:;" layuimini-href="page/button.html?v=3"
                                                             target="_self"> <i class="fa fa-snowflake-o"></i> <span
                                            class="layui-left-nav"> 按钮3</span></a></dd>
                                    <dd class="menu-dd  "><a href="javascript:;" layuimini-href="page/form.html?v=1"
                                                             target="_self"> <i class="fa fa-calendar"></i> <span
                                            class="layui-left-nav"> 表单4</span></a></dd>
                                </dl>
                            </dd>
                        </dl>
                    </dd>
            ...
            <li class="layui-nav-item menu-li  "><a href="javascript:;" layuimini-href="page/error.html" target="_self">
                <i class="fa fa-superpowers"></i> <span class="layui-left-nav">失效菜单</span></a></li>
            <span class="layui-nav-bar"></span></ul>--%>
    </div>
    ...
    layui.use(['jquery', 'layer', 'miniAdmin', 'miniTongji'], function () {
        ...
        $('.login-out').on("click", function () {
            layer.msg('退出登录成功', function () {
                window.location = '${pageContext.request.contextPath}/admins/log';
            });
        });
    });
</script>
