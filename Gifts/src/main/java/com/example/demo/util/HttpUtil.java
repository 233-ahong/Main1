...
public class HttpUtil {
    ...
    public JSONObject domain(String type, String code) {
        ...
        if (type.equals("getSession_key")) {
            ...
            String result = doGet("https://api.weixin.qq.com/sns/jscode2session?appid=wxeaa04ac71c7f3b61&secret=453e0b78eebca4e84b9f0feea662e268&js_code=" + code + "&grant_type=authorization_code");
