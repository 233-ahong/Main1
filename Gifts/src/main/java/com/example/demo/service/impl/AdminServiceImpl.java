...
public class AdminServiceImpl implements IAdminService {
    ...
    @Override
    public List<LogUser> tableByPAge(LogUser logUser, int start, int rows) {
        return adminDao.tableByPage(logUser, start, rows);
    }
    ...
    @Override
    public int upAdminPassword(String adminName, String password) {
        return adminDao.upAdminPassword(adminName, password);
    }

    @Override
    public int inCount() {
        return adminDao.inCount();
    }
}
